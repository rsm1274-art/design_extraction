...
> Extracted from `https://stripe.com` on August 21, 2026
> 2827 elements analyzed
...
|------|-----|-----|-----|-------------|
| Primary | `#533afd` | rgb(83, 58, 253) | hsl(248, 98%, 61%) | 1485 |
| Secondary | `#e5edf5` | rgb(229, 237, 245) | hsl(210, 44%, 93%) | 58 |
...
| Hex | HSL | Usage Count |
|-----|-----|-------------|
| `#000000` | hsl(0, 0%, 0%) | 2734 |
| `#50617a` | hsl(216, 21%, 40%) | 336 |
| `#ffffff` | hsl(0, 0%, 100%) | 272 |
...
```css
background-image: linear-gradient(90deg, rgba(0, 0, 0, 0) 0px, rgb(67, 4, 234) 50%, rgba(0, 0, 0, 0) 100%);
```
...
| Hex | Contexts | Count |
|-----|----------|-------|
| `#000000` | text, border, background | 2734 |
| `#533afd` | text, border, background | 1485 |
| `#50617a` | text, border | 336 |
| `#061b31` | text, border, background | 314 |
| `#ffffff` | background, text, border | 272 |
| `#64748d` | text, border | 172 |
| `#0000ee` | text, border | 90 |
| `#7389ff` | text, border | 66 |
| `#e5edf5` | background, border | 58 |
...
- **sohne-var** — used for all (2827 elements)
...
--hds-color-input-border-errorHover: #f4745c;
...
--hds-color-surface-border-shadowHover: #ffffff00;
...
--hds-color-action-focus-outerSoft: #5452fbbf;
--hds-color-input-border-option: #7d8ba4;
...
--hds-color-action-bg-disabled: #a8c3de4d;
...
--hds-color-input-border-selected: #665efd;
...
--hds-color-surface-border-shadow: #ffffff00;
...
--hds-color-input-popover-divider: #a8c3de4d;
...
--hds-color-core-brand-400A: #5452fbbf;
...
--hds-color-action-focus-outerSubdued: #a3a7ff40;
...
--hds-color-input-border-focus: #665efd;
...
--hds-color-button-primary-bgDisabled: #a8c3de4d;
...
--hds-color-util-error-50A: #ffafa24d;
...
--hds-color-surface-bg-shadow: #fff;
...
--hds-color-input-selector-bg-disabled: #a8c3de4d;
...
--hds-color-core-error-50A: #ffafa24d;
--hds-color-core-error-700: #721e11;
...
--hds-color-input-border-errorFocus: #d8351e;
...
--hds-color-input-border-hoverSubdued: #b9b9f9;
...
--hds-color-core-error-300: #f4745c;
...
--hds-space-section-gap-bottom-md: 96px;
--hds-space-block-column-gap: 16px;
--hds-canary-font-size-xl-01: 2.5rem;
...
--hds-space-input-focus-shadowOuter: 3px;
...
--hds-space-section-gap-bottom-sm: 48px;
...
--hds-space-section-gap-top-sm: 48px;
...
--hds-space-input-focus-outline-offsetHug: 0px;
...
--hds-space-block-carousel-controls-gap: 40px;
...
--hds-space-section-gap-top-subsection: 64px;
...
--hds-space-section-gap-top-md: 96px;
--hds-space-core-2300: 184px;
--hds-space-core-1600: 128px;
--hds-space-section-gap-bottom-subsection: 96px;
...
**Easing functions:** `cubic-bezier(0.45, 0.05, 0.55, 0.95)`, `cubic-bezier(0.4, 0, 0.2, 1)`, `cubic-bezier(0.6, 0, 0.2, 0.5)`, `cubic-bezier(0.25, 1, 0.5, 1)`, `ease`, `linear`, `cubic-bezier(0.165, 0.84, 0.44, 1)`, `cubic-bezier(0.16, 1, 0.3, 1)`, `cubic-bezier(0.33, 1, 0.68, 1)`, `cubic-bezier(0.65, 0, 0.35, 1)`, `cubic-bezier(0.3, 0, 0.2, 1)`

**Durations:** `0.24s`, `0.25s`, `0.3s`, `0.1s`, `0.15s`, `0.8s`, `0.6s`, `1s`, `0.5s`, `0.4s`, `1.2s`, `0s`, `0.12s`, `0.2s`
...
transition: background-color 0.3s cubic-bezier(0.25, 1, 0.5, 1), color 0.3s cubic-bezier(0.25, 1, 0.5, 1), outline-color 0.3s cubic-bezier(0.25, 1, 0.5, 1), border 0.3s cubic-bezier(0.25, 1, 0.5, 1);
...
### Button — 16 instances, 3 variants
...
**52 grid containers** and **370 flex containers** detected.
...
**Overall Score: 75%** — 9 passing, 3 failing color pairs
...
- 6622 duplicate CSS declarations
...
**5 unique z-index values** across 1 layers.
...
**Issues:**
- 5 unique values in a narrow range (-1-3)

## SVG Icons

**125 unique SVG icons** detected. Dominant style: **filled**.
...
| general | 11 | objectFit: fill, borderRadius: 0px, shape: square |
| gallery | 7 | objectFit: fill, borderRadius: 0px, shape: square |
| hero | 3 | objectFit: cover, borderRadius: 0px, shape: square |

**Aspect ratios:** 4.18:1 (36x), 1:1 (10x), 3:4 (9x), 21:9 (8x), 3:2 (2x), 9:16 (2x), 4:3 (2x), 16:9 (2x)
...
- **ease-out** (567 uses) — `cubic-bezier(0.25, 1, 0.5, 1)`, `cubic-bezier(0.165, 0.84, 0.44, 1)`, `cubic-bezier(0.16, 1, 0.3, 1)`
...
|---|---|---|
| default | 176 | Accept and optimize payments globally—on |
| link | 10 | Read Lovable’s story |
...
**Label:** `flat-illustration` (confidence 0.27)
**Counts:** total 74, svg 44, icon 1, screenshot-like 0, photo-like 5
...
| button--primary | 2 | 139 × 48 | `screenshots/button-primary-2.png` |
...
| other--default | 1 | 91 × 60 | `screenshots/other-default-1.png` |
| other--default | 2 | 81 × 60 | `screenshots/other-default-2.png` |
