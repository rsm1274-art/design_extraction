...
```ts
export const tokens = {
  colors: ['#000000', '#533afd', '#50617a', '#061b31', '#ffffff', '#64748d', '#0000ee', '#7389ff', '#e5edf5', '#7f7dfc', '#3c4f69', '#273951', '#1a2c44', '#ff6118'],
  fonts: ['[object Object]'],
  radii: ['1', '4', '8', '16', '100'],
  shadows: ['rgba(23, 23, 23, 0.06) 0px 3px 6px 0px', 'rgba(50, 50, 93, 0.12) 0px 16px 32px 0px', 'rgba(23, 23, 23, 0.08) 0px 15px 35px 0px'],
};
```
## Sections
- cta
