# You are building UI in the roberttran.com.au design system.
...
- title         Robert Tran - Brisbane Web Developer
- page intent   landing
- material      flat
- design grade  B
...
- families   caslonText · franklin · jetbrainsMono · caslonDisplay
- weights    400 · 700 · 500 · 600 · 900 · 800
- base size  16px
...
- durations  40ms · 100ms · 160ms · 260ms
...
```bash
npx designlang roberttran.com.au
```
...
Generated by designlang. Re-extract by running `npx designlang roberttran.com.au`.
