# You are building UI in the ishikawa.co design system.
...
- title         ishikawa.co — Walkable Atlas by Hidekazu Ishikawa
- page intent   landing
...
- secondary   #4ee8dd
- accent      #d45199
- neutrals    #1f1f1f · #333735 · #2f302d · #000000 · #486c62 · #ffffff

## Typography

- families   Avenir Next · Ishikawa Klee · Times New Roman · Helvetica Neue
- weights    400 · 600 · 500 · 700 · 620
- base size  16px
...
- scale      1px · 6px · 50px · 53px · 56px · 70px

## Motion

- durations  80ms · 140ms · 160ms · 260ms
...
Generated by designlang. Re-extract by running `npx designlang ishikawa.co`.
