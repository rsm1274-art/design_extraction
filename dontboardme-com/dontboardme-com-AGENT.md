# You are building UI in the dontboardme.com design system.
...
- families   Times New Roman · Bayon · Neue Montreal · Arial
- weights    400 · 500 · 700
- base size  16px

## Spacing

- scale      1px · 18px · 21px · 24px · 28px · 36px · 39px · 43px · 50px · 57px · 60px · 64px

## Radii

- scale      3px · 9px · 50px · 133px · 662px
...
```bash
npx designlang dontboardme.com
```
...
Generated by designlang. Re-extract by running `npx designlang dontboardme.com`.
